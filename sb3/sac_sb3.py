...
def main():
    ...
    if args.mode == 'train':
        ...
        # Start training
        print(f"Starting SAC training with {total_timesteps} timesteps...")
        ...
        for episode in range(test_episodes):
            ...
            while not done:
                action, _ = model.predict(obs, deterministic=True) # SAC uses deterministic actions for evaluation
